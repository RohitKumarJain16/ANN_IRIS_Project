...
# Improved Custom CSS with better contrast and visibility
st.markdown("""
<style>
    /* Main header styling */
    .main-header {
...
def main():
    ...
    model = load_or_create_model(X_train_scaled, y_train_cat)
    ...
    if page == "🏠 Home":
        ...
        with col2:
            if hasattr(st.session_state, 'prediction_made') and st.session_state.prediction_made:
                ...
                # Probability distribution with updated colors
